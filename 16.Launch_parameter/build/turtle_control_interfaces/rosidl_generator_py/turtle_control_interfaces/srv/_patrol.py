...
class Metaclass_Patrol(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtle_control_interfaces.srv.Patrol')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtle_control_interfaces.srv import _patrol
...
class Patrol(metaclass=Metaclass_Patrol):
    from turtle_control_interfaces.srv._patrol import Patrol_Request as Request
    from turtle_control_interfaces.srv._patrol import Patrol_Response as Response
