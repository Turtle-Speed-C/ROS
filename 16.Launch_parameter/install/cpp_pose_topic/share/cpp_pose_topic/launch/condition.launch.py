...
def generate_launch_descripation():
    # 声明参数，是否创建新的海龟
    declare_spaw_turtle = launch.actions.DeclareLaunchArgument(
        "spaw_turtle", default_value="False", description="是否生成新的海龟"
    )

    spaw_turtle = launch.substitutions.LaunchConfiguration("spaw_turtle")
    ...
    action_executeprocess = launch.actions.ExecuteProcess(
        condition=IfCondition(spaw_turtle),
    ...
    launch_description = launch.LaunchDescription(
        [declare_spaw_turtle, action_turtle, action_group]
    )
